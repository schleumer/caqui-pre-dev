...
var URLSource = function () {
  ...
  URLSource.prototype.build = function build(query, limit, page) {
    ...
    if (source instanceof Function) {
      ...
      return _url2.default.format(Object.assign({}, _url2.default.parse(source), { query: {
          count: limit,
          page: page,
          q: query
        } }));
...
var dataStore = function dataStore(_source) {
  ...
  var reducer = function reducer() {
    ...
    switch (action.type) {
      case 'FILTER':
        return m("FILTEr", _extends({}, state, {
          filter: data
        }));
      case 'FIRST_PAGE':
      ...
      case 'GO_TO_PAGE':
        return m("GO_TO_PAGE", _extends({}, state, {
          page: data
        }));
      case 'SET_ITEMS':
        return m("SET_ITEMS", _extends({}, state, {
          items: data.items,
          total: data.total,
