                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "button",
                                { type: "button", className: "caqui-button caqui-button-xs caqui-button-default",
                                    onClick: addHour },
                                "+"
                            )
                        ),
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement("input", { type: "text", value: current.format('HH'), onChange: this.hourChanged,
                                className: "form-control", ref: "hour" })
                        ),
                        _react2.default.createElement(
                            "td",
                            { className: "caqui-datetime-footer-minute" },
                            _react2.default.createElement("input", { type: "text", value: current.format('mm'), onChange: this.minuteChanged,
                                className: "form-control", ref: "minute" })
                        )
                    ),
                    _react2.default.createElement(
                        "tr",
