...
var DateTime = function (_React$Component) {
    ...
    DateTime.prototype.render = function render() {
        ...
        if (opened) {
            dropDown = _react2.default.createElement(_dropDown2.default, { store: this.store, key: current.format("YYYY-MM"), onDatePicked: this.datePicked,
                onTimeChanged: this.onTimeChanged, showTime: this.props.time });
        }
