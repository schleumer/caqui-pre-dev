...
var Dropdown = function (_React$Component) {
  ...
  Dropdown.prototype.onInput = function onInput() {
    ...
    this.inputDebounce = setTimeout(function () {
      store.dispatch(store.actions.filter(_this2.refs.search.value));
    }, 300);
  };
  ...
  Dropdown.prototype.render = function render() {
    ...
    var items = data.items.map(function (e, index) {
      ...
      return _react2.default.createElement(
        'li',
        { key: itemKey(e), className: classes.join(' ') },
        _react2.default.createElement(
          'a',
          { href: 'javascript:;', onClick: _this4.select(e), tabIndex: '-1' },
          itemLabel(e)
        )
      );
    });
    ...
    return _react2.default.createElement(
      'div',
      { style: { userSelect: 'none' }, ref: 'holder' },
      _react2.default.createElement(
        'ul',
        { className: 'combobox-dropdown-menu dropdown-menu', style: { display: 'block' } },
        _react2.default.createElement(
          'li',
          { className: 'dropdown-menu-search' },
          _react2.default.createElement('input', { type: 'text', className: 'form-control', ref: 'search', defaultValue: data.filter, onChange: this.onInput, onBlur: this.onBlur, onFocus: this.onFocus,
