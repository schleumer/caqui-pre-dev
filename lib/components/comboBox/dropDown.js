...
var Dropdown = function (_React$Component) {
    ...
    Dropdown.prototype.render = function render() {
        ...
        if (this.props.footer) {
            footer = [_react2.default.createElement('li', { key: '_divider', role: 'separator', className: 'caqui-combobox-dropdown-list-separator' }), _react2.default.createElement(
                'li',
                { key: '_footer', className: 'caqui-combobox-dropdown-list-text' },
                data.status
            )];
        }
