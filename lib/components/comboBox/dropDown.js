...
var Dropdown = function (_React$Component) {
  ...
  Dropdown.prototype.render = function render() {
    ...
    var items = data.items.map(function (e, index) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          {
            href: 'javascript:',
            onClick: _this3.select(e),
            tabIndex: '-1',
            className: 'caqui-combobox-dropdown-list-item-anchor' },
          itemLabel(e)
        )
      );
    });
    ...
    if (this.props.footer) {
      footer = [_react2.default.createElement('li', {
        key: '_divider',
        role: 'separator',
        className: 'caqui-combobox-dropdown-list-separator' }), _react2.default.createElement(
        'li',
        {
          key: '_footer',
    ...
    return _react2.default.createElement(
      'div',
      {
        className: (0, _classnames2.default)('caqui-combobox-dropdown-holder', className),
        ref: 'holder' },
      _react2.default.createElement(
        'div',
