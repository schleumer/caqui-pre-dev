...
var Shadow = function (_React$Component) {
  ...
  Shadow.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      'div',
      { className: 'combobox-display', tabIndex: data.opened ? '-1' : '0', onFocus: this.displayFocused, onClick: this.displayFocused, ref: 'displayer' },
      label,
      _react2.default.createElement(
        'div',
        { className: 'combobox-display-icon', tabIndex: '-1' },
