...
var TextInput = function (_Base) {
  ...
  TextInput.prototype.onFocus = function onFocus() {
  ...
  TextInput.prototype.onBlur = function onBlur() {
  ...
  TextInput.prototype.render = function render() {
    ...
    var style = m(_extends({}, styles.normal, this.props.style), this.state.focused && styles.focused);
