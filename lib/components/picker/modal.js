...
var Modal = function (_React$Component3) {
  ...
  function Modal(props) {
    ...
    _this3.searchKeyDown = _this3.searchKeyDown.bind(_this3);
    _this3.searchDebounce = null;
    return _this3;
  }

  Modal.prototype.searchKeyDown = function searchKeyDown(event) {
    switch (event.which) {
      case 27:
  ...
  Modal.prototype.search = function search(event) {
    var _this4 = this;
    ...
    this.searchDebounce = setTimeout(function () {
      _this4.props.adapter.filter(query);
    }, 300);
  };
  ...
  Modal.prototype.render = function render() {
    ...
    var items = this.props.items.map(function (item) {
      return _react2.default.createElement(Item, {
        key: _this7.props.itemKey(item.value),
        adapter: _this7.props.adapter,
        item: item,
        itemLabel: _this7.props.itemLabel,
        checkedItems: _this7.props.checkedItems,
        indexedItems: _this7.props.indexedItems,
        onChecked: _this7.onItemChecked,
        onUnchecked: _this7.onItemUnchecked });
    });
    ...
    if (totalOfPages > 1) {
      ...
      pagination = _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'ul',
            { className: 'pagination', style: { padding: '5px', margin: 0 } },
            _react2.default.createElement(
              PaginationButton,
              {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _button2.default,
            { style: { marginRight: 5 }, onClick: this.close },
            'Cancelar'
          ),
          _react2.default.createElement(
            _button2.default,
            { type: _button2.default.Primary, onClick: this.props.onConfirm },
            'Salvar'
          )
        )
      )
