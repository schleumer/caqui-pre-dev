...
var select = (0, _reselect.createSelector)(function (state, props) {
    return {
        errors: state.caquiErrors.filter(function (_) {
            return _.field.indexOf(props.namespace) > -1;
        }),
        messages: state.caquiMessages.filter(function (_) {
            return _.field.indexOf(props.namespace) > -1;
        })
    };
}, function (_) {
...
var AlertBox = function (_Base3) {
    ...
    AlertBox.prototype.render = function render() {
        ...
        var messagesBoxes = messages.map(function (_) {
            return _react2.default.createElement(MessageBox, { silence: _this6.props.silence, key: _.id, item: _,
                onClick: _this6.forgetMessage(_) });
        });
        var errorsBoxes = errors.map(function (_) {
            return _react2.default.createElement(ErrorBox, { silence: _this6.props.silence, key: _.id, item: _,
                onClick: _this6.forgetError(_) });
        });
