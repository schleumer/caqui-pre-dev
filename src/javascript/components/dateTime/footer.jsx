                ...
                <table className="caqui-datetime-footer-table">
                    ...
                    <tr>
                        <td className="caqui-datetime-footer-add-hour">
                            <button type="button" className="caqui-button caqui-button-xs caqui-button-default"
                                    onClick={addHour}>+
                            </button>
                        </td>
                    ...
                    <tr>
                        <td className="caqui-datetime-footer-hour">
                            <input type="text" value={ current.format('HH') } onChange={this.hourChanged}
                                   className="form-control" ref="hour"/>
                        </td>
                        <td className="caqui-datetime-footer-minute">
                            <input type="text" value={ current.format('mm') } onChange={this.minuteChanged}
