...
class Page extends Base {
  ...
  render() {
    ...
    if (icon) {
      iconEl = (
        <Icon
          className="caqui-page-header-icon"
          name={ icon }
    ...
    return (
      <div className="row-fluid caqui-page-header">
        <div className="row-fluid">
          <h2
            className="caqui-page-header-title pull-left"
            style={ { marginBottom: '0px', marginTop: '15px', marginLeft: '15px', marginRight: '15px' } }>{ iconEl }
            <span>{ header }</span></h2>
