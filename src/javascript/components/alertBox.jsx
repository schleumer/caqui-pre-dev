...
class AlertBox extends Base {
    ...
    render() {
        ...
        const messagesBoxes = messages.map(_ => <MessageBox silence={ this.props.silence } key={ _.id } item={ _ }
                                                            onClick={ this.forgetMessage(_) }/>);
        const errorsBoxes = errors.map(_ => <ErrorBox silence={ this.props.silence } key={ _.id } item={ _ }
